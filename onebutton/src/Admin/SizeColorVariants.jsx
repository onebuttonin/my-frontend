...
export default function EditProduct() {
  ...
  const updateSizeStock = (size, stock) => {
    ...
    axios
      .put(
        `${import.meta.env.VITE_API_URL}/products/${id}/update-size`,
        { size, stock },
        { headers: { Authorization: `Bearer ${token}` } }
      )
      .then((response) => {
  ...
  const addSize = () => {
    ...
    axios
      .put(
        `${import.meta.env.VITE_API_URL}/products/${id}/add-size`,
  ...
  const deleteSize = (size) => {
    ...
    const token = localStorage.getItem("admin_token");
    axios
      .delete(`${import.meta.env.VITE_API_URL}/products/${id}/delete-size`, {
        data: { size },
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
  ...
  const addColor = () => {
    ...
    axios
      .put(
        `${import.meta.env.VITE_API_URL}/products/${id}/add-color`,
        { color: newColor },
        { headers: { Authorization: `Bearer ${token}` } }
      )
      .then((response) => {
  ...
  const deleteColor = (color) => {
    ...
    const token = localStorage.getItem("admin_token");
    axios
      .delete(`${import.meta.env.VITE_API_URL}/products/${id}/delete-color`, {
        data: { color },
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
