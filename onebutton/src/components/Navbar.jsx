...
//   // Detect scroll (ticker disappears after ~60px, adjust if needed)
//   useEffect(() => {
//     const handleScroll = () => {
//       if (window.scrollY > 60) {
//         setIsSticky(true);
...
//         {/* Logo */}
//         <h1 className="text-2xl md:text-3xl font-bold flex-1">OneButton</h1>
...
//             </button>
//           </li>
//           <li><Link to="/login"><User className="w-6 h-6 cursor-pointer hover:border-b" /></Link></li>
//           <li><Link to="/wishlist"><Heart className="w-6 h-6 cursor-pointer hover:border-b" /></Link></li>
//           <li><Link to="/cart"><ShoppingCart className="w-6 h-6 cursor-pointer hover:border-b" /></Link></li>
//         </ul>
...
//         <div className="bg-neutral-100 p-4 shadow-md mt-2">
//           <ul className="flex flex-col md:flex-row md:space-x-4">
//             <li><Link to="/" className="block text-gray-700 hover:border-b">Home</Link></li>
//             <li><Link to="/category" className="block text-gray-700 hover:border-b">Category</Link></li>
//             <li><Link to="/login" className="block text-gray-700 hover:border-b">Profile</Link></li>
//             <li><Link to="/wishlist" className="block text-gray-700 hover:border-b">Wishlist</Link></li>
//             <li><Link to="/OrderDetails" className="block text-gray-700 hover:border-b">Orders</Link></li>
//             <li><a href="#" className="block text-gray-700 hover:border-b">About</a></li>
//             <li><a href="#" className="block text-gray-700 hover:border-b">Contact</a></li>
//           </ul>
//         </div>
//       )}
//     </nav>
