...
//   const [currentIndex, setCurrentIndex] = useState(null); // ✅ which image is open
...
//   const imageReviews = reviews.filter(r => r.review_image); // ✅ only those with images
...
//                       alt="Review"
//                       className="w-16 h-16 object-cover border border-gray-200 cursor-pointer rounded-sm hover:opacity-90"
//                       onClick={() => setCurrentIndex(imageReviews.findIndex(item => item.id === r.id))}
...
//                 {renderStars(imageReviews[currentIndex].rating)}
//               </div>
